        ...
        <div class="w-4/12 bg-white p-6 rounded-lg">
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    @error('name')
                        <div class="text-red-500 mt-2 sm-text">
                            {{ $message }}
                        </div>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" id="name" placeholder="Your email" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('email') border-red-500 @enderror" value="{{ old('email') }}">
                ...
                <div class="mb-4">
                    <label for="password_confirmation" class="sr-only">Pasword</label>
